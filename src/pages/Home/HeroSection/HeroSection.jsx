...
function HeroSection() {
    ...
    return (
        <div className={theme == "light" ? `${s.hero} ${a.section} ${a.fade_section}` : `${s.hero} ${a.section} ${a.fade_section} ${s.darkHero}`} ref={heroRef}>
            ...
            <div className={`${a.photos} ${s.photos}`} ref={containerRef}>
